...
<div style="margin-top:2%">
	...
	<font id="ft" style="margin-left:5%">当 前 考 生：<span id="sp">${sessionScope.studentName }</span></font>
</div>
...
<center style="margin-top:10%">
	<font>CopyRight : www.xiaowu.com<br><br>使用技术：springmvc、spring、mybatis</font>
</center>
</body>
</html>